...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url(); ?>frontend-assets/favicon.png">
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/frontend-assets/css/main.css">

   <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/frontend-assets/translate/style.css">
   <link href="https://fonts.googleapis.com/icon?family=Material+Icons"
      rel="stylesheet">
   <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/frontend-assets/css/jquery.exzoom.css" media="all" /> 
   <!-- Facebook Pixel Code -->
<style type="text/css">
...
src="https://www.facebook.com/tr?id=136621337651519&ev=PageView
    ...
    <div class="container">
      ...
      <div class="header__left">
        <div class="menu--product-categories">
          ...
          <div class="menu__content header_menu-cats" id="">
      ...
      <div class="header__center">
        <form class="ps-form--quick-search" action="<?php echo site_url('products'); ?>" method="get">
          <div class="form-group--icon"><i class="icon-chevron-down"></i>
            <select name="cats" class="form-control cats">
          ...
          <input class="form-control" name="s" id="tags" type="text" placeholder="I'm shopping for...">
...
<?php foreach ($this->cart->contents() as $item){  ?>
                <div class="ps-product--cart-mobile">
                  ...
                  <div class="ps-product__content"><a class="ps-product__remove" href="<?php echo base_url('cart/removeItem/'.$item["rowid"]); ?>"><i class="icon-cross"></i></a><a href="#"><?php echo $item['name'] ?></a>
                    <small><?php echo $item["qty"]; ?> x <?php echo $currency ; ?> <?php echo $curr_symbol[$currency]; ?> <?php echo $this->frontend_m->convert($item['price']) ; ?></small>
                  </div>
                </div>
<?php } ?>
              ...
              <div class="ps-cart__footer">
                <h3>Sub Total:<strong><?php echo $currency ; ?> <?php echo $curr_symbol[$currency]; ?><?php if(count($this->cart->contents()) !=0 ){
                  echo $this->frontend_m->convert($item["subtotal"]); }else{
                    echo '0';
                  } ?></strong></h3>
  ...
  <nav class="navigation">
    <div class="container">
      <div class="navigation__left">
        <div class="menu--product-categories" style="background-color: transparent;
    display: block;">
...
<a href="#">Ship To <?php echo $this->session->userdata('country'); ?>/<?php echo $this->session->userdata('currency'); ?></a>
            <ul class="ps-dropdown-menu new_dropdown1 ">
              <li> 
                  <h4>Select Regional Settings</h4>
              </li>
            ...
            <div class="ps-cart__items">
              ...
              <?php foreach ($this->cart->contents() as $item){  ?>
                <div class="ps-product--cart-mobile">
                  <div class="ps-product__thumbnail"><a href="#"><img src="<?php  echo base_url() ;  ?>/admin-assets/images/<?php echo $item['image']; ?>" alt=""></a></div>
                  <div class="ps-product__content"><a class="ps-product__remove" href="<?php echo base_url('cart/removeItem/'.$item["rowid"]); ?>"><i class="icon-cross"></i></a><a href="#"><?php echo $item['name'] ?></a>
                    <p><strong>Sold by:</strong> Zatara Store</p><small><?php echo $item["qty"]; ?> x $<?php echo $item['price'] ; ?></small>
                  </div>
                </div>
<?php } ?>
        ...
        <div class="ps-block--user-header">
          <div class="ps-block__left"><i class="icon-user" title="<?php  if($this->session->userdata('email') != ''){ echo  $this->session->userdata('fname');  } ?>"></i></div>
          <div class="ps-block__right">
            
            <?php  if($this->session->userdata('email') == ""){  ?>
            <a href="<?php echo site_url('users/login') ?>">Login</a><a href="<?php echo site_url('users/login?action=register') ?>">Register</a>
          <?php }else{ ?>
