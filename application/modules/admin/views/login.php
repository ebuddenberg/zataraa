            ...
            <div class="vd_login-page" style="background: #fff;margin-bottom: 30px;box-shadow: 6px 8px 11px #000;">
              ...
              <div class="panel widget">
                <div class="panel-body">
                  ...
                  <form class="form-horizontal" method="post" id="login-form" action="<?php echo site_url('admin/login'); ?>" role="form">
...
<?php if($this->session->flashdata('success')){ ?>      
                  <div class="alert alert-success">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="icon-cross"></i></button>
                    <span class="vd_alert-icon"><i class="fa fa-check-circle vd_green"></i></span><strong>Success!</strong>. </div>
                    <?php } ?>                  
                      ...
                      <div class="col-md-12">
                        <div class="row">
                          <div class="col-xs-6 text-right">
                            <div class=""> <a href="<?php echo site_url('admin/forget_password'); ?>">Forget Password? </a> </div>
                          </div>
                        </div>
                      </div>
                    </div>
