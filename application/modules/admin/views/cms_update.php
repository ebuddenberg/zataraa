              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title" style="display: inline-block;"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> <?php echo $cms->title ; ?>   <span> </span></h3>
                    
                  </div>
                  <div class="panel-body table-responsive">
                    <form action="<?php echo site_url('admin/update_cms') ; ?>" class="form-horizontal" id="login-form" method="post" accept-charset="utf-8">
                        
                        <input type="hidden" id="id" name="id" value="<?php echo $this->uri->segment(3) ; ?>">
                
                    <div class="form-group">
                            <label for="name_1" class="control-label col-lg-3 required"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="page title">Page Title </span> </label>
                            <div class="col-lg-9">
                               
                                  <input type="text" required="" name="title" class="  updateCurrentText " id="product_name" value="<?php echo $cms->title ; ?>">
                                
                            </div>
                  </div>
                  <div class="form-group">
                            <label for="description_short_1" class="control-label col-lg-3"> <span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="Appears in the product list(s), and at the top of the product page."> Page Content </span> </label>
                            <div class="col-lg-9 mgbt-xs-10 mgbt-lg-0">
                              <textarea name="content" id="description_short" data-rel="ckeditor" rows="1" ><?php echo $cms->content ; ?></textarea>
                            </div>
