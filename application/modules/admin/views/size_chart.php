              ...
              <div class="col-md-12">
                <div class="panel widget">
                  <div class="panel-heading vd_bg-grey">
                    <h3 class="panel-title" style="display: inline-block;"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Size Chart List   </h3>
                    <h3 class="panel-title text-center" style="display: inline-block;width: 100%; position: absolute; left: 0; cursor: pointer;">
                          <span data-toggle="modal" data-target="#myModaladduser" ><i class="fa fa-plus fa-fw"></i> Add Size Chart</span>
                    </h3>
                  </div>
                  <div class="panel-body table-responsive">
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <?php
                         foreach ($size_chart_list as $data) { ?>

                        <tr>
                          <td><?php echo $data->id ; ?></td>
                         
                          <td class="center"><?php echo $data->chart_name ; ?></td>
                          <td class="center"><img src="<?php echo base_url(); ?>admin-assets/<?php echo $data->images ; ?>" width="100"></td>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row"> 
                 <div class="col-md-12"> 
                   <form action="<?php echo site_url('admin/product/update_csize') ; ?>" class="form-horizontal"  method="post"  enctype="multipart/form-data">
                        <div id="error"></div>
                <input type="hidden" name="size_id1" id="Size_id10">        
                  <div class="form-group">
                    <div class="col-md-12">
                      <label class="control-label  col-sm-4">Size Chart Name<span class="vd_red">*</span></label>
                      <div id="first-name-input-wrapper" class="controls col-sm-8">
                        <input type="text" placeholder="Size Name" class="width-60 required" required="" name="csize_name" id="cSize_name01">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                   <label class="control-label col-sm-4">Thumbnail*</label>
                   <div id="first-name-input-wrapper" class="controls col-sm-8">
                     <input type="file" class="width-60 required" name="thumbnail">
                   </div>
                  </div>
                  <p id="img01" style="text-align: center;"></p>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row"> 
                  <div class="col-md-12"> 
                  <form  class="form-horizontal" action="<?php echo base_url(); ?>/admin/product/add_csize"  method="post" enctype="multipart/form-data" >
                        <div id="error11"></div>
                <input type="hidden" name="Product Size_id" id="Product Size_id">        
                  <div class="form-group">
                    <div class="col-md-12">
                      ...
                      <div id="first-name-input-wrapper" class="controls col-sm-8">
                        <input type="text" placeholder="Size Name" class="width-60 required" required="" name="csize_name" id="Size_name">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                   <label class="control-label col-sm-4">Thumbnail*</label>
                   <div id="first-name-input-wrapper" class="controls col-sm-8">
                     <input type="file"  class="width-60 required" name="thumbnail"  required="">
                   </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-2"></div>
                    <div class="col-md-7 mgbt-xs-10 ">
                       <div class="mgtp-10">
                        <button class="btn edit vd_bg-green vd_white pull-right add_size" type="submit" id="submit-register" name="submit-register">Submit</button>
                      </div>
                    </div>
                    <div class="col-md-12 mgbt-xs-5"> </div>
                  </div>
   ...
   $(document).ready(function(){
      $('.table').on('click', '.vd_bd-yellow', function(){
         ...
         var id = $(this).data('id');
          ...
          $.ajax({
                  type:'post',
                  url:'<?php echo site_url() ; ?>/admin/product/csize_view/'+id ,
                  cache: false,
                  dataType: 'json'
              })
          .done(function(data){ 
              ...
              $('#Size_id10').val(data.id);
              $('#cSize_name01').val(data.chart_name);
              $('#img01').html('<img src="<?php echo site_url() ; ?>/admin-assets/'+data.images+'" width="50">');
...
<script type="text/javascript">
  ...
  $('.table').on('click', '.vd_bd-red', function(){
    ...
    $.ajax({
      type: "post",
      url:'<?php echo site_url('admin/product/delete_csize/') ; ?>'+id ,
      cache: false,       
