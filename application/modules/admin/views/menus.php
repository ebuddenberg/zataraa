                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td class="center"><?php echo $data->main_heading ; ?></td>
                          <td class="center"><?php echo $data->parent_menu ; ?></td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row"> 
                  ...
                  <form action="<?php echo site_url('admin/product/add_menu') ; ?>" class="form-horizontal" id="login-form" method="post" enctype='multipart/form-data' >
                        <div id="error"></div>
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <label class="control-label  col-sm-4">Main Heading<span class="vd_red">*</span></label>
                      <div id="first-name-input-wrapper" class="controls col-sm-8">
                        <select class="width-60 required"   name="main_menu">
                              <option value="Wholesale">Wholesale</option>
                              <option value="Free Shipping Deals">Free Shipping Deals</option>
                              <option value="Stock lot deals">Stock lot deals</option>
                              <option value="Personal Shopping">Personal Shopping</option>
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <label class="control-label  col-sm-4">Parent Menu</label>
                      <div id="company-input-wrapper" class="controls col-sm-8">
                        <input type="text" placeholder="Parent Menu" class="width-60 required" name="parent">
                      </div>
                    </div>
                  </div>
                   <div class="form-group">
...
<script type="text/javascript" src="http://localhost/gulfislamicstore/admin-assets/custom/custom.js"></script><script type="text/javascript" src="http://localhost/gulfislamicstore/admin-assets/js/chosen.jquery.js"></script>
<script type="text/javascript">
  jQuery(document).ready(function(){
  jQuery(".main_heading").chosen();
 });
 </script>
<script type="text/javascript">
...
$('.table').on('click', '.vd_bd-red', function(){
    ...
    $.ajax({
      type: "post",
      url:'<?php echo site_url('admin/product/delete_menu/') ; ?>'+id ,
      cache: false,       
