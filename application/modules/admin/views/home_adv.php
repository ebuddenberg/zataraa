    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">View Home Ads</h4>
        </div>
...
<div class="modal fade popup-style" id="myModaledit" role="dialog" >
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Edit Home Ads</h4>
        </div>
        <div class="modal-body" id="dynamic-content" >
          <div class="row"> 
                     <div class="col-md-12"> 

                  <form action="<?php echo site_url('admin/general_setting/update_home_ads') ; ?>" class="form-horizontal" id="login-form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div id="error"></div>
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <label class="control-label  col-sm-4"> url <span class="vd_red">*</span></label>
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <label class="control-label  col-sm-4"> Image <span class="vd_red">*</span></label>
                  ...
                  <div class="form-group">
                    <div class="col-md-12">
                      <label class="control-label col-sm-4"> Type<span class="vd_red">*</span></label>
...
<div class="modal fade popup-style" id="myModaladduser" role="dialog" >
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Add Home Ads Details</h4>
        </div>
        <div class="modal-body">
          <div class="row"> 
                <div class="col-md-12"> 
                   <form action="<?php echo site_url('admin/general_setting/add_home_ads') ; ?>" class="form-horizontal" id="login-form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <div id="error"></div>
...
<script type="text/javascript">
  $(document).ready(function(){
     ...
     $.ajax({
      type:'post',
      url:'<?php echo site_url() ; ?>/admin/general_setting/view_home_ads/'+id ,
      cache: false,
      dataType: 'json'
  })
  ...
  .done(function(data){ 
      ...
      $('#url01').val(data.ads_link);
      $('#type01').val(data.position);
 ...
 $('.table').on('click', '.vd_bd-green', function(){
  ...
  .done(function(data){ 
      $('#dynamic-content').hide(); // hide dynamic div
      $('#dynamic-content').show(); // show dynamic div
      $('#ads_url').html(data.ads_link);
      $('#ads_image').html('<img src="<?php echo site_url() ; ?>admin-assets/homecate/'+data.images+'" width="100">');
      $('#ads_posi').html(data.position);
...
<script type="text/javascript">
 ...
 $('.table').on('click', '.vd_bd-red', function(){
  if (window.confirm("Do you really want to delete?")) { 
    ...
    $.ajax({
      type: "post",
      url:'<?php echo site_url('admin/general_setting/delete_home_ads/') ; ?>'+id ,
      cache: false,       
