    ...
    $image = '';
                        ...
                        <tr>
                          ...
                          <td class="center">
                            ...
                            <?php 
                            $js = array('class' => 'recommended','data-id' => $data->product_id );
                            $options = array('yes' => 'yes','no' => 'no');
                              echo form_dropdown('recommended', $options, $data->recomended ,$js);
                        ...
                        <td class="center">
                            ...
                            <?php 
                            $js = array('class' => 'deal_of_the_weak','data-id' => $data->product_id );
                            $options = array('yes' => 'yes','no' => 'no');
                              echo form_dropdown('deal_of_the_weak', $options, $data->deal_of_the_weak ,$js);
                             ?>
                        </td>
                          <td class="center">
...
$('.recommended').on('change', function(e) {
  var id = $(this).data("id");
    $.ajax({
      type: "post",
      url:'<?php echo site_url('admin/product/update_recomended/') ; ?>',
      data: { rec : this.value ,id :id} ,
      cache: false,       
      success: function(response){            
...
$('.deal_of_the_weak').on('change', function(e) {
  var id = $(this).data("id");
    $.ajax({
      type: "post",
      url:'<?php echo site_url('admin/product/update_deal_of_the_week/') ; ?>',
      data: { rec : this.value ,id :id} ,
      cache: false,       
      success: function(response){            
