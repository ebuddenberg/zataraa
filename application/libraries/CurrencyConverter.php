...
class CurrencyConverter
{
    ...
    public function convert($fromCurrency, $toCurrency, $amount, $saveIntoDb = true, $hourDifference = 120)
    {
    ...
    {
        $url = 'http://apilayer.net/api/live?source='.$this->fromCurrency.'&currencies='.$this->toCurrency.'&format=1&access_key='.$this->currencyApiKey;
        ...
        if (isset($result)) {
            ...
            if(isset($conversion['quotes'])){
                 $conversion = $conversion['quotes'] ;
            }else{
                return  $this->rate = 1;
            }
                  if (isset($conversion[$this->fromCurrency.$this->toCurrency])) {
                return  $conversion[$this->fromCurrency.$this->toCurrency];
