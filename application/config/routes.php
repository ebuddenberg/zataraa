...
$route['admin/orders/(:num)'] = 'admin/orders';
$route['admin/general_setting/(:num)'] = 'admin/general_setting';
...
$route['users/(:num)'] = 'frontend/users';
$route['(:any)'] = 'frontend/$1';
$route['products/adv_search'] = 'frontend/products/adv_search';
$route['products/(:any)'] = 'frontend/products';
$route['products/(:any)/(:any)'] = 'frontend/products/';
$route['categories/(:any)'] = 'frontend/categories';
